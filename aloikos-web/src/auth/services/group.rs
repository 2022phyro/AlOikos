...
use crate::{ auth::dto::GroupUpdateDto, db::db, new_model};
use super::super::models::prelude::{Group, GroupActiveModel, GroupModel};

pub async fn create(name:String, description:String , is_admin_group: bool) -> Result<GroupModel, DbErr> {
    let group = new_model!(
        GroupActiveModel, {
            name: name,
